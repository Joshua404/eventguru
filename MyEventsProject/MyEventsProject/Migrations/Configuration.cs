namespace MyEventsProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyEventsProject.Models.ApplicationDbContext>
    {
        ...
        {
            // delete everything from States table to reseed database
            if (context.States.Count() == 0)
            {
                ...
                var Bellevue = new City { Name = "Bellevue" };
                var Redmond = new City { Name = "Redmond" };
                var Renton = new City { Name = "Renton" };

                //Oregon Cities
                var Portland = new City { Name = "Portland" };
                var Salem = new City { Name = "Salem" };
                var Beaverton = new City { Name = "Beaverton" };
                var Bend = new City { Name = "Bend" };

                //Idaho Cities
                var Boise = new City { Name = "Boise" };
                var Nampa = new City { Name = "Nampa" };
                var Caldwell = new City { Name = "Caldwell" };
                var Lewiston = new City { Name = "Lewiston" };
                ...
                var WA = new State
                {
                   ...
                   {
                       Seattle, Bellevue, Redmond, Renton
                   }
                };
                var OR = new State
                {
